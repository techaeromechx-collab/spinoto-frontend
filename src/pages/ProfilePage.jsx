...
const PERM_GROUP_ORDER = [
  'Administration', 'Leads', 'Vehicles', 'Services',
  'Pricing', 'Hubs', 'Appointments', 'Customers',
  'Estimates', 'Invoices', 'Operations',
];

// ── Group icon helper (same logic as UsersPage) ───────────────────────────────
function roleGroupIcon(group) {
  const g = (group || '').toLowerCase();
  if (g.includes('admin') || g.includes('user'))
  ...
  if (g.includes('vehicle') || g.includes('car'))
  ...
  if (g.includes('service') || g.includes('repair'))
  ...
  if (g.includes('pric') || g.includes('cost'))
  ...
  if (g.includes('hub') || g.includes('location'))
  ...
  if (g.includes('appoint') || g.includes('customer'))
  ...
  if (g.includes('invoice') || g.includes('estimate') || g.includes('finance'))
  ...
  if (g.includes('report') || g.includes('analytic'))
