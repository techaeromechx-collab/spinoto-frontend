...
function getGroupIcon(group) {
  ...
  if (g.includes('admin') || g.includes('user')) return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  // Vehicles
  if (g.includes('vehicle') || g.includes('car')) return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  // Services / Wrench
  if (g.includes('service') || g.includes('repair') || g.includes('work')) return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  // Pricing / Tag
  if (g.includes('pric') || g.includes('cost') || g.includes('rate') || g.includes('fee')) return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  // Operations / Settings / Other
  if (g.includes('operat') || g.includes('setting') || g.includes('config')) return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  // Reports / Analytics
  if (g.includes('report') || g.includes('analytic') || g.includes('stat')) return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  if (g.includes('location') || g.includes('master') || g.includes('area')) return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
