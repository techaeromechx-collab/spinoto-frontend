...
const NOTIF_META = {
  ...
  no_activity:        { Icon: Activity,      bg: '#ffedd5', color: '#ea580c', label: 'No Activity'  },
...
const NAV_ITEMS = [
  { label: 'Dashboard',    to: '/',           permissions: [],                            icon: LayoutDashboard },
  {
    ...
    icon: Database,
    children: [
      { label: 'Locations',          to: '/master/locations', permissions: [], icon: MapPin },
      { label: 'Vehicles',           to: '/master/vehicles',  permissions: [], icon: Car },
      { label: 'Services & Pricing', to: '/master/services',       permissions: [], icon: Wrench },
      { label: 'Lead Statuses',      to: '/master/lead-statuses',  permissions: [], icon: Tag       },
      { label: 'Departments',        to: '/master/departments',    permissions: [], icon: Building2 },
      { label: 'Parts',              to: '/master/parts',          permissions: [], icon: Package   },
      { label: 'Discounts',          to: '/master/discounts',      permissions: [], icon: Percent   },
    ],
  },
  { label: 'HUBs',         to: '/hubs',         permissions: ['VIEW_HUB','MANAGE_HUBS','CREATE_HUB','EDIT_HUB'], icon: Network },
  { label: 'Leads',        to: '/leads',        permissions: ['VIEW_LEAD','CREATE_LEAD'], icon: Users },
  { label: 'Appointments', to: '/appointments', permissions: ['VIEW_LEAD','CREATE_LEAD'], icon: Calendar },
  { label: 'Estimates',          to: '/estimates',         permissions: [],                          icon: FileText    },
  { label: 'Purchase Invoices', to: '/purchase-invoices', permissions: [],                          icon: ReceiptText },
  { label: 'Customer Invoices', to: '/customer-invoices', permissions: [],                          icon: Receipt     },
  { label: 'Hub Payouts',       to: '/payouts',           permissions: [],                          icon: Wallet      },
  { label: 'Customers',         to: '/customers',         permissions: ['VIEW_LEAD','CREATE_LEAD'], icon: Users2      },
