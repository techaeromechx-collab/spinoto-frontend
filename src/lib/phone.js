 ...
 *
 * So every lead WhatsApp button was opening wa.me/9876543210 — a number with no
 * country code, which WhatsApp cannot resolve. And the appointments version
 ...
 *
 * Returning null rather than a best-effort URL is the point: a hidden or
 * disabled button tells the user the number is unusable, where a broken link
 * tells them WhatsApp is broken.
 */
